...
const Home = () => {
    ...
    return (
        <>
            {/* Hero area */}
            <section
                className="relative h-[230vh] sm:h-[210vh] md:h-[110vh] bg-cover bg-center"
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['City', 'House', 'Residential', 'Apartment'].map((filter) => (
                                    <button
                                        key={filter}
                                        type="button"
                                        className="px-4 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-full text-sm text-[#374151] hover:bg-[#E5E7EB]"
                                    >
                                        {filter}
                                    </button>
                                ))}
