...
const Search = () => {
    ...
    useEffect(() => {
        ...
        const typeFormUrl = urlParams.get('parking');
    ...
    return (
        <div className='flex flex-col md:flex-row'>
            <div className='p-7 border-b-2 sm:border-r-2 md:min-h-screen'>
                <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                    ...
                    <div className="flex gap-2 flex-wrap items-center">
                        ...
                        <div className="flex gap-2">
                            <input onChange={handleChange} checked={sidebardata.parking} type="checkbox" id="parking" className='w-5' /><span>Parking</span>
                        </div>
                        <div className="flex gap-2">
            ...
            <div className=''>
                <h1 className='text-3xl font-semibold boder-b p-3 text-slate-700'>Listing Results</h1>
            </div>
        </div>
    )
}
