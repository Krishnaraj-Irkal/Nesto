        ...
        const fetchListing = async () => {
            try {
                ...
                if (data.success === false) {
                    setError(data.message || 'Unable to fetch listing');
                    setLoading(false);
                    return;
                }
                setFormData(data);
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 pb-12">
                ...
                <header className="mb-6">
                    ...
                    <p className="text-sm text-[#6B7280] mt-1">
                        Edit details, images, and pricing. The first image is used as the
                        cover.
                    </p>
                </header>
                ...
                {loading && (
                    <div className="mb-6 text-sm text-[#6B7280]">Loading listing…</div>
                )}
                {error && (
                ...
                {!loading && (
                    <form
                        ...
                        className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_420px] gap-8"
                    >
                        {/* LEFT: Details card */}
                           ...
                           placeholder-[#9CA3AF] focus:outline-none focus:border-[#00C896] focus:ring-2 focus:ring-[#00C896]"
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {/* Keep checkboxes (ids) for your logic; style as pills */}
                                    <label
                                        className={`cursor-pointer inline-flex items-center gap-2 px-4 py-2 rounded-full border ${formData.type === 'rent'
                                    ...
                                    <label
                                        className={`cursor-pointer inline-flex items-center gap-2 px-4 py-2 rounded-full border ${formData.type === 'sale'
                                            ? 'bg-[#1B1B1B] text-white border-[#1B1B1B]'
                                            : 'border-[#E5E7EB] text-[#374151]'
                                            }`}
                                    >
                                ...
                                <div className="mt-4 text-sm font-medium text-[#374151]">
                                    Features
                                </div>
                                <div className="mt-2 flex flex-wrap gap-3">
                                    {[
                                        ...
                                        <label
                                            key={opt.id}
                                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#E5E7EB] text-[#374151] cursor-pointer"
                                        >
                                            <input
                                                id={opt.id}
                                                type="checkbox"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                             ...
                             focus:outline-none focus:border-[#00C896] focus:ring-2 focus:ring-[#00C896]"
                                ...
                                <div className="flex flex-col">
                                    ...
                                    >
                                        Regular price{' '}
                                        <span className="text-[#6B7280]">(₹ / month for rent)</span>
                                    </label>
                                    <input
                                        id="regularPrice"
                                        type="number"
